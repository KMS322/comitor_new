...
import PayModal from "./pay1Modal";
import "../../CSS/pay.css";
          ...
          <div id="mobile" className="article_container">
            {typeof me !== "undefined"
              ? me === 0
                ...
                : carts.map((cartProduct, index) => {
                    const selectedProduct = products.find(
                      (item) => item.product_code === cartProduct.product_code
                    );
                    return (
                      <>
                        ...
                        <div className="pay_btn" onClick={handlePaymentClick}>
                          {onCoupon
                            ? (totalPrice - salePrice).toLocaleString()
                            : totalPrice.toLocaleString()}
                          원 결제하기
